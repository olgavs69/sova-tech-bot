...
# Обновление состояний для регистрации
...
async def login_input_handler(message: Message, state: FSMContext) -> None:
...
async def password_input_handler(message: Message, state: FSMContext) -> None:
